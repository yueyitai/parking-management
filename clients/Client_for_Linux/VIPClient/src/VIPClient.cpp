...
bool EClient::operateDatabase(enum optCode optCode, char* recvBuf, const char* data)
{
	...
	{
		request = { { VIPCLIENT_INSERT_ONE_INFO ,"VIPClientInsertOneInfo" }, "null" };
		break;
	}
	case VIPCLIENT_QUERY_ONE_INFO_BY_PLATE:
	{
		request = { { VIPCLIENT_QUERY_ONE_INFO_BY_PLATE ,"VIPClientQueryOneInfoByPlate" }, data };
		break;
	}
	case VIPCLIENT_UPDATE_ONE_INFO_BY_PLATE:
	{
		request = { { VIPCLIENT_UPDATE_ONE_INFO_BY_PLATE ,"VIPClientUpdateOneInfoByPlate" }, data };
		break;
	}
	default:
		break;
