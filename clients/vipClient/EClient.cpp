...

{
    ...
    case VIPCLIENT_INSERT_ONE_INFO:
        request = { optCode, "VIPCLIENT_INSERT_ONE_INFO", data };
        break;
    case VIPCLIENT_QUERY_ONE_INFO_BY_PLATE:
        request = { optCode, "VIPCLIENT_QUERY_ONE_INFO_BY_PLATE", data };
        break;
    case VIPCLIENT_UPDATE_ONE_INFO_BY_PLATE:
        request = { optCode, "VIPCLIENT_UPDATE_ONE_INFO_BY_PLATE", data };
        break;
    default:
        return false;
    }
