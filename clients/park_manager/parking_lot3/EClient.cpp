...

{
    ...
    case PCLIENT_QUERY_ONE_INFO_BY_PLATE:
        request = { optCode, "PclientQueryOneInfoByPlate", data };
        break;
    case PCLIENT_INSERT_ONE_INFO:
        request = { optCode, "PclientInsertOneInfo", data };
        break;
    case PCLIENT_DELETE_ONE_INFO_BY_PLATE:
        request = { optCode, "PclientDeleteOneInfoByPlate", data};
        break;
    case PCLIENT_QUERY_PLATE_EXISTENCE_IN_EMPLOYEE_TABLE_BY_PLATE:
        request = { optCode, "PclientQueryPlateExistenceInEmployeeTableByPlate", data };
        break;
	case PCLIENT_QUERY_PLATE_EXISTENCE_IN_VIP_TABLE_BY_PLATE:
        request = { optCode, "PclientQueryPlateExistenceInVipTableByPlate", data };
        break;
    default:
        return false;
    }
